...
CREATE FUNCTION AUTENTICAR(USER varchar(30), CONTRA varchar(30)) RETURNS CHAR(1)
BEGIN
...
INSERT INTO PROVINCIA (CODPROV, NOMPROV, DEPARTAMENTO_CODDEP)
    VALUES
    (1, 'CHACHAPOYAS ', 1),
    (2, 'BAGUA', 1),
    (3, 'BONGARA', 1),
...
INSERT INTO DISTRITO (CODDIS, NOMDIS, PROVINCIA_CODPROV)
    VALUES
    (1, 'CHACHAPOYAS', 1),
    (2, 'ASUNCION', 1),
    (3, 'BALSAS', 1),
...
INSERT INTO STOCK
    (PRODUCTO_CODPRO_PROSTK, INPSTK, OUTSTK, FECINP, FECOUT)
    VALUES
    (1,2,0,'2019-02-10','');