...
SELECT * FROM VENTA ORDER BY CODVEN ASC;
...
SELECT PRODUCTO.CODPRO, PRODUCTO.NOMPRO, CATEGORIA.NOMCAT,MARCA.NOMMAR, MODELO.NOMMOD, PRODUCTO.SERPRO, PRODUCTO.FECGARPRO, PRODUCTO.PREPRO FROM MODELO 
INNER JOIN PRODUCTO ON PRODUCTO.MODELO_CODMOD_MODPRO = MODELO.CODMOD
